...
public:
	...
	GameSceneContext()
	{
		...
		collision_system = std::make_unique<CollisionSystem>();
		...
		//キャラクターマネージャー生成
		character_manager = std::make_unique<CharacterManager>(*movement_system, *collision_system, *animation_system, *rendering_system);
